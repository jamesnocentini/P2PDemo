...
},{"./components/form.jsx":158,"./components/list.jsx":159,"./utils/api":160,"react":156}],158:[function(require,module,exports){
"use strict";
...
var Form = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { style: styles.docForm },
                React.createElement(
                    "label",
                    { "for": "input-name", style: styles.label },
                    "Name"
                ),
                React.createElement("input", { type: "text", id: "input-name" })
            ),
            React.createElement(
                "div",
                { style: styles.docForm },
                React.createElement(
                    "label",
                    { "for": "input-meal", style: styles.label },
                    "Meal"
                ),
                React.createElement("input", { type: "text", id: "input-meal" })
            ),
            React.createElement(
                "button",
                { onClick: this.create, style: styles.button, id: "create-doc" },
                "Create document"
            ),
            React.createElement(
                "p",
            ...
            React.createElement("input", { id: "target", ref: "target", style: styles.input, type: "text" }),
            React.createElement(
                "button",
                { onClick: this.replicate, style: styles.button, id: "replicate" },
                "Replicate"
            )
        );
    },
...
},{"./../utils/api":160,"react":156}],159:[function(require,module,exports){
"use strict";
        ...
        var docs = this.state.docs.map(function (doc, i) {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "button",
                        { onClick: self.deleteDocument.bind(self, doc.id, doc.doc._rev), style: styles.button },
                        "Delete"
                    )
                )
            );
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("th", { style: styles.column })
                ),
                docs
            )
        );
...
},{"./../utils/api":160,"react":156}],160:[function(require,module,exports){
"use strict";
